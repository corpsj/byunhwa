...
export default function Home() {
  ...
  const normalizeSchedule = (schedule: ApiSchedule): ScheduleOption | null => {
    if (typeof schedule === 'string') {
      return { time: schedule, capacity: 100, reserved: 0, remaining: 100 };
    }
    ...
    if (schedule && typeof schedule === 'object' && typeof schedule.time === 'string') {
      return {
        ...
        reserved: typeof schedule.reserved === 'number' ? schedule.reserved : 0,
        remaining: typeof schedule.remaining === 'number' ? schedule.remaining : 100,
      };
    }
      ...
      try {
        ...
        if (Array.isArray(data.schedules)) {
          loadedSchedules = data.schedules
            ...
            .filter((schedule): schedule is ScheduleOption => Boolean(schedule?.time));
        } else {
